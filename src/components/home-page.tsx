...
export function HomePage() {
  ...
  return <main className="overflow-hidden">
    ...
    <Countdown />
    <section className="site-container flex min-h-[90vh] flex-col items-center justify-center py-28 text-center"><p className="font-display text-5xl text-muted-foreground md:text-7xl">Markets move.</p><p className="font-display text-6xl md:text-8xl">MINDS MOVE THEM.</p><h2 className="mt-8 font-display text-6xl text-lime md:text-9xl">WHAT WILL YOU MOVE?</h2><Button asChild size="lg" className="mt-12 h-14 rounded-full px-8"><Link to="/register">Enter FINVERSE <ArrowRight /></Link></Button></section>
  </main>;
}
